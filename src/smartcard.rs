...
mod tests {
    ...
    #[test]
    fn run() {
        let data_to_sign = [49_u8, 61, 48, 22, 6, 9, 42, 134, 72, 134, 247, 13, 1, 9, 3, 49, 9, 6, 7, 43, 6, 1, 5, 2, 3, 1, 48, 35, 6, 9, 42, 134, 72, 134, 247, 13, 1, 9, 4, 49, 22, 4, 20, 22, 144, 59, 22, 68, 47, 213, 64, 69, 126, 237, 38, 151, 109, 213, 92, 122, 198, 202, 21];
        ...
        let expected_signature = [16_u8, 72, 236, 185, 169, 67, 103, 61, 147, 20, 88, 198, 7, 245, 226, 138, 7, 104, 68, 169, 60, 51, 19, 138, 191, 107, 30, 236, 118, 28, 236, 193, 47, 203, 31, 232, 194, 70, 127, 74, 243, 3, 135, 113, 207, 86, 135, 254, 180, 142, 82, 143, 66, 62, 26, 128, 118, 76, 136, 182, 64, 201, 24, 109, 205, 2, 11, 38, 20, 23, 174, 181, 77, 185, 70, 251, 127, 138, 3, 71, 203, 81, 106, 206, 141, 190, 157, 114, 141, 102, 255, 223, 247, 118, 165, 202, 132, 129, 245, 223, 35, 20, 57, 221, 183, 195, 39, 247, 239, 194, 145, 127, 30, 95, 82, 143, 173, 211, 200, 107, 54, 199, 211, 146, 177, 41, 101, 251, 253, 184, 13, 147, 150, 216, 145, 186, 37, 179, 47, 198, 114, 15, 195, 236, 209, 57, 90, 29, 200, 233, 207, 105, 185, 81, 10, 89, 26, 132, 82, 97, 239, 207, 74, 32, 178, 57, 86, 220, 10, 116, 199, 206, 77, 122, 94, 113, 174, 11, 64, 125, 254, 22, 198, 238, 195, 27, 86, 199, 211, 89, 106, 136, 4, 201, 150, 21, 157, 72, 7, 21, 117, 159, 111, 166, 211, 223, 25, 166, 217, 5, 50, 61, 74, 192, 202, 1, 115, 130, 71, 65, 99, 54, 31, 142, 99, 150, 229, 175, 135, 55, 152, 43, 222, 238, 91, 46, 204, 115, 94, 231, 141, 68, 86, 120, 227, 154, 225, 252, 37, 91, 148, 206, 96, 185, 198, 108];
        ...
        println!("{:0x?} {}", signature, signature.as_slice() == expected_signature.as_slice());
    }
